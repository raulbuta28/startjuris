...
class PlansContent extends StatelessWidget {
  const PlansContent({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    const List<List<Color>> miniCardGradients = [
      [Color(0xFF0288D1), Color(0xFF03A9F4), Color(0xFF4FC3F7)],
      [Color(0xFFD81B60), Color(0xFFF06292), Color(0xFFF8BBD0)],
      [Color(0xFF388E3C), Color(0xFF4CAF50), Color(0xFFA5D6A7)],
      [Color(0xFFFF5722), Color(0xFFFF8A65), Color(0xFFFFAB91)],
      [Color(0xFF6A1B9A), Color(0xFFAB47BC), Color(0xFFE1BEE7)],
      [Color(0xFFFFC107), Color(0xFFFFE082), Color(0xFFFFECB3)],
    ];
